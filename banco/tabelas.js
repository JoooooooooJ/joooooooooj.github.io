class Tabelas {
    ...
    criarRepositorios() {
        ...
        const sqlUser = 'CREATE TABLE IF NOT EXISTS Users (id int NOT NULL AUTO_INCREMENT, username varchar(50) NOT NULL UNIQUE, password varchar(200) NOT NULL, type varchar(5), PRIMARY KEY(id))'
